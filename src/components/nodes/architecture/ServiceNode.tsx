...
const ServiceNode = ({ id, data, selected, ...props }: NodeProps) => {
    const { customIcons } = useIconContext();
    const typeStr = 'service'; // Fixed type for this component
    ...
    return (
        ...
        >
            <div className={`relative z-10 flex flex-col h-full w-full items-center justify-center p-2 overflow-hidden`}>
                ...
                {data.description && (
                    <div className="text-[10px] text-muted-foreground mt-1 leading-snug w-full break-words whitespace-normal text-center overflow-hidden">
